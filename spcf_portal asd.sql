...
--
-- Host: 127.0.0.1
-- Generation Time: May 01, 2025 at 06:22 PM
...
(2, 'ADM5444', 'dags', 'dags@gmail.com', 'qwekqwek123', NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL, '2025-05-01 23:48:37', NULL);
...
INSERT INTO `students` (`student_id`, `student_number`, `name`, `email`, `password`, `program`, `courses`, `year_level`, `section`, `date_of_birth`, `birthdate`, `gender`, `contact_number`, `phone`, `address`, `emergency_contact_name`, `emergency_contact_number`, `enrollment_date`, `is_active`, `status`, `email_verified`, `verification_token`, `reset_token`, `reset_token_expires`, `last_login`, `created_at`, `updated_at`) VALUES
(1, '0122302706', 'gab', 'gab@gmail.com', 'qwekqwek123', 'BSCS', NULL, 3, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 'Active', 0, NULL, NULL, NULL, NULL, '2025-04-28 02:48:22', NULL);
...
--
ALTER TABLE `additional_info`
  ADD CONSTRAINT `additional_info_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`);
...
--
ALTER TABLE `education_background`
  ADD CONSTRAINT `education_background_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`);

--
-- Constraints for table `emergency_contacts`
--
ALTER TABLE `emergency_contacts`
  ADD CONSTRAINT `emergency_contacts_ibfk_1` FOREIGN KEY (`student_id`) REFERENCES `students` (`student_id`);
